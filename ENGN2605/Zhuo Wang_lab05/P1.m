...
[i1, i2, s1, s2] = find_matches(R5, R6,"NCC", 0.9);
...
[i1, i2, s1, s2] = find_matches(R7, R8,"Chi−Square", 0.65);
...
[f7, d7] = vl_sift(I7,'PeakThresh',peakthresh,'edgethresh',edgethresh);
[f8, d8] = vl_sift(I8,'PeakThresh',peakthresh,'edgethresh',edgethresh);
...
[c9, c10] = coordinates_find_sift(i1, s1, f1, f2);

visualize_matches(I1, I2, c9, c10, 20);

a5 = accuracy_compute(image_dir1, c9, c10);
disp("sift (1) accuracy rate is:");
disp(a5);


[i1, i2, s1, s2] = find_matches(d3, d4,"sift", 0.65);

[c11, c12] = coordinates_find_sift(i1, s1, f3, f4);

visualize_matches(I3, I4, c11, c12, 20);

a6 = accuracy_compute(image_dir2, c11, c12);
disp("sift (2) accuracy rate is:");
disp(a6);


[i1, i2, s1, s2] = find_matches(d5, d6,"sift", 0.65);

[c13, c14] = coordinates_find_sift(i1, s1, f5, f6);

visualize_matches(I5, I6, c13, c14, 20);

a7 = accuracy_compute(image_dir3, c13, c14);
disp("sift (3) accuracy rate is:");
disp(a7);


[i1, i2, s1, s2] = find_matches(d7, d8,"sift", 0.75);

[c15, c16] = coordinates_find_sift(i1, s1, f7, f8);

visualize_matches(I7, I8, c15, c16, 20);

a8 = accuracy_compute(image_dir4, c15, c16);
disp("sift (4) accuracy rate is:");
disp(a8);
