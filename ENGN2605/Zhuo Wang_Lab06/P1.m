...
I1 = single(im2gray(imread("images\problem_1\Golden_Gate\goldengate-02.png")));
I2 = single(im2gray(imread("images\problem_1\Golden_Gate\goldengate-03.png")));
I3 = single(rgb2gray(imread("images\problem_1\LEMS_lab\lems-01.png")));
I4 = single(rgb2gray(imread("images\problem_1\LEMS_lab\lems-02.png")));
I5 = single(rgb2gray(imread("images\problem_1\PVD_City_Hall\1900.jpg")));
I6 = single(rgb2gray(imread("images\problem_1\PVD_City_Hall\2016.jpg")));
...
im5 = imread("images\problem_1\PVD_City_Hall\1900.jpg");
im6 = imread("images\problem_1\PVD_City_Hall\2016.jpg");
...
[warpedImage1, leftTopUnwarpX1, leftTopUnwarpY1, warpImgWeight1] = getNewImg(h2, im3, im4);
blendType = 'weightBlend';
...
[c5, c6] = coordinates_find_sift(i1, s1, f5, f6);
h3 = Ransac4Homography(c5, c6);

[warpedImage1, leftTopUnwarpX1, leftTopUnwarpY1, warpImgWeight1] = getNewImg(h3, im5, im6);
blendType = 'weightBlend';
[stitchedImage] = blendImgs(warpedImage1, im5, leftTopUnwarpX1, leftTopUnwarpY1, blendType, warpImgWeight1);
figure();
imshow(uint8(stitchedImage));
